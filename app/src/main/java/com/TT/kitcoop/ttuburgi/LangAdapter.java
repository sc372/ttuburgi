...
public class LangAdapter extends BaseAdapter {
    ...
    public LangAdapter(Context context, ArrayList<Select_Item> listViewItemList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.lang_listitem, parent, false);
        }

        //화면에 표시될 View로부터 위젯에 대한 참조 획득
        ImageView iconImageView = (ImageView)convertView.findViewById(R.id.lang_imgView);
        TextView titleTextView = (TextView)convertView.findViewById(R.id.lang_textView1);
        TextView txtTextView = (TextView)convertView.findViewById(R.id.lang_textView2);
